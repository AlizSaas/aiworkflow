  ...
  >
    {
     ...
     {
      status === 'error' && (
        <XCircleIcon className="absolute right-0.5 bottom-0.5 size-3 text-red-700 stroke-3" />
      )
    }
     {
      status === 'success' && (
        <CheckCircle2Icon className="absolute right-0.5 bottom-0.5 size-3 text-green-700 stroke-3" />
      )
    }
     {
      status === 'loading' && (
        <Loader2Icon className="absolute -right-0.5 -bottom-0.5 size-3 text-blue-700 stroke-3 animate-spin" />
      )
    }
